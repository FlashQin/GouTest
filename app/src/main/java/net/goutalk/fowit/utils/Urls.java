...
public class Urls {
    ...
    public static String urlnine="https://openapi.dataoke.com/api/goods/nine/op-goods-list?";//搜索
    public static String urlSerch="https://openapi.dataoke.com/api/goods/list-super-goods?";//搜索
    public static String urlranking="https://openapi.dataoke.com/api/goods/get-ranking-list?";//榜单
    public static String urlgoodsinfo="https://openapi.dataoke.com/api/goods/get-goods-details?";//榜单
    public static String urlgoodslinke="https://openapi.dataoke.com/api/tb-service/get-privilege-link?";//转链接
    public static String urllove="https://openapi.dataoke.com/api/goods/list-similer-goods-by-open?";//猜你喜欢
