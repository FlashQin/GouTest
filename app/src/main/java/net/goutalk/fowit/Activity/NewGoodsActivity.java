...
import net.goutalk.fowit.Bean.NewGoodsBean;
...
public class NewGoodsActivity extends BaseActivity implements OnRefreshListener, OnLoadMoreListener {
    ...
    private BaseQuickAdapter<NewGoodsBean.DataBean.ListBean, BaseViewHolder> mAdapterList;
    private TTAdNative mTTAdNative;
    private TTNativeExpressAd mTTAd;
    private List<NewGoodsBean.DataBean.ListBean> mListData;
    ...
    public void initView() {
        ...
        TTAdManagerHolder.get().requestPermissionIfNecessary(NewGoodsActivity.this);
    ...
    private void initHomeList() {
        ...
        //初始化RecycleView
        LinearLayoutManager ms = new LinearLayoutManager(NewGoodsActivity.this);
        ...
        recyclerviewHomeList.setAdapter(mAdapterList = new BaseQuickAdapter<NewGoodsBean.DataBean.ListBean, BaseViewHolder>(R.layout.item_rec_shop_layout) {
            @Override
            protected void convert(BaseViewHolder helper, NewGoodsBean.DataBean.ListBean item) {
                ...
                if (item.getmData() == false) {
                 ...
                 //   TextView txtgou = helper.itemView.findViewById(R.id.tv_open_time);
                    ...
                    Glide.with(NewGoodsActivity.this).load(item.getMainPic()).apply(options).into(imageView);
                ...
                .subscribe(new BaseObserver<BaseMsgBean>() {
                    ...
                    public void onNext(BaseMsgBean codeBean) {
                        if (codeBean.getCode() == 0) {
                            NewGoodsBean nineToNineBean = JSONObject.parseObject(JSONObject.toJSONString(codeBean), NewGoodsBean.class);
