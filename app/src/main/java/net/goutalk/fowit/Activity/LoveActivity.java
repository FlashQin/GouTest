...
public class LoveActivity extends BaseActivity implements OnRefreshListener, OnLoadMoreListener {
    ...
    private List<LikeBean.DataBean> mListData;
    ...
    public void initView() {
        ...
        TTAdManagerHolder.get().requestPermissionIfNecessary(LoveActivity.this);
    ...
    private void initHomeList() {
        ...
        //初始化RecycleView
        LinearLayoutManager ms = new LinearLayoutManager(LoveActivity.this);
            ...
            protected void convert(BaseViewHolder helper, LikeBean.DataBean item) {
                ...
                if (item.getmData() == false) {
                   ...
                   // TextView txtgou = helper.itemView.findViewById(R.id.tv_open_time);
                    ...
                    Glide.with(LoveActivity.this).load(item.getMainPic()).apply(options).into(imageView);
