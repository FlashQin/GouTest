...
public class ArilActivity extends BaseActivity {
    ...
    private void postwechat(String wechat) {
        RxHttp.postForm("/easyfowit-mini/member/addAlipayNo.do?alipayNo="+wechat)
