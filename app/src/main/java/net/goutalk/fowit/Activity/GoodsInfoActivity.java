...
public class GoodsInfoActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        api = WXAPIFactory.createWXAPI(GoodsInfoActivity.this, CommonUtils.APP_ID_WX, false);
        //将应用的appid注册到微信
    ...
    public void goTaoByItemUrl(String url) {
        ...
        // 通过百川内部的webview打开页面
        AlibcTrade.openByUrl(GoodsInfoActivity.this, "", url, null,
    ...
    private void initData() {
        ...
        paraMap.put("id", (ID));
        paraMap.put("goodsId", (ID.equals("-1") ? goodsId : "-1"));
        ...
        RxHttp.get(Urls.urlgoodsinfo + p)
                ...
                .subscribe(new BaseObserver<BaseMsgBean>() {
                    ...
                    public void onNext(BaseMsgBean codeBean) {
                        ...
                        if (codeBean.getCode() == 0) {
                            ...
                            //  txtgou.setText("勾转专享价￥" + goodsDetileBean.getData().getActualPrice() + "");
                            shopNameYou.setText("领券后可减￥" + goodsDetileBean.getData().getCouponPrice());

                            for (int i = 0; i < goodsDetileBean.getData().getImgs().split(",").length; i++) {
                                imgs.add(goodsDetileBean.getData().getImgs().split(",")[i]);
                            }
                            CommonUtils.imgsgoodspic = imgs;
                            //  mAdapterList.addData(imgs);
                            initBanner();
                            initTabLayout();
...
//    }
    ...
    private void initSpecDialog() {
        ...
        dialog_spec = DialogPlus.newDialog(GoodsInfoActivity.this)
        ...
        mRec.setLayoutManager(new GridLayoutManager(GoodsInfoActivity.this, 4));
        mRec.setAdapter(specAdapter = new BaseQuickAdapter<ShareBean, BaseViewHolder>(R.layout.itemshare) {
            ...
            protected void convert(BaseViewHolder helper, ShareBean item) {
                ...
                Glide.with(GoodsInfoActivity.this).load(item.getImg()).into((ImageView) helper.getView(R.id.imgpic));
        ...
        specAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (position == 2) {
                    ...
                    sharetoQQ(GoodsInfoActivity.this, params);
                }
                if (position == 3) {
...
//                    miniProgramBundle.putStringArrayList(QzoneShare.SHARE_TO_QQ_IMAGE_URL, imageUrls);
                    ...
                    sharetoQzONE(GoodsInfoActivity.this, miniProgramBundle);
                }
