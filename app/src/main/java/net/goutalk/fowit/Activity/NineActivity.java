...
import net.goutalk.fowit.Bean.NineToNineBean;
...
public class NineActivity extends BaseActivity implements OnRefreshListener, OnLoadMoreListener {
    ...
    private BaseQuickAdapter<NineToNineBean.DataBean.ListBean, BaseViewHolder> mAdapterList;
    private TTAdNative mTTAdNative;
    private TTNativeExpressAd mTTAd;
    private List<NineToNineBean.DataBean.ListBean> mListData;
    ...
    public void initView() {
        ...
        TTAdManagerHolder.get().requestPermissionIfNecessary(NineActivity.this);
    ...
    private void initHomeList() {
        ...
        //初始化RecycleView
        LinearLayoutManager ms = new LinearLayoutManager(NineActivity.this);
        ...
        recyclerviewHomeList.setAdapter(mAdapterList = new BaseQuickAdapter<NineToNineBean.DataBean.ListBean, BaseViewHolder>(R.layout.item_rec_shop_layout) {
            @Override
            protected void convert(BaseViewHolder helper, NineToNineBean.DataBean.ListBean item) {
                ...
                if (item.getmData() == false) {
                   ...
                   // TextView txtgou = helper.itemView.findViewById(R.id.tv_open_time);
                    ...
                    Glide.with(NineActivity.this).load(item.getMainPic()).apply(options).into(imageView);
                ...
                .subscribe(new BaseObserver<BaseMsgBean>() {
                    ...
                    public void onNext(BaseMsgBean codeBean) {
                        if (codeBean.getCode() == 0) {
                            NineToNineBean nineToNineBean = JSONObject.parseObject(JSONObject.toJSONString(codeBean), NineToNineBean.class);
