...
public class ZreoActivity extends BaseActivity implements OnRefreshListener, OnLoadMoreListener {
    ...
    public void initView() {
        ...
        TTAdManagerHolder.get().requestPermissionIfNecessary(ZreoActivity.this);
    ...
    private void initHomeList() {
        ...
        //初始化RecycleView
        LinearLayoutManager ms = new LinearLayoutManager(ZreoActivity.this);
        ...
        recyclerviewHomeList.setAdapter(mAdapterList = new BaseQuickAdapter<ZoreBean.DataBean.ListBean, BaseViewHolder>(R.layout.item_zreo_layout) {
            ...
            protected void convert(BaseViewHolder helper, ZoreBean.DataBean.ListBean item) {
                ...
                if (item.getmData() == false) {
                    ...
                    Glide.with(ZreoActivity.this).load(item.getMainPic()).apply(options).into(imageView);
...
//        }
      ...
      //  RxHttp.get(Urls.urlzroe + p)
        RxHttp.get("/goods/zero/op-goods-list.json")
                .add("pageNum",pagenum)
